...
if __name__ == "__main__":
    ...
    while True:
        try:
            ...
            if data_inputs['ema5'].iloc[-3]>data_inputs['ema100'].iloc[-3] and data_inputs['ema8'].iloc[-3]<data_inputs['ema100'].iloc[-3] and data_inputs['ema5'].iloc[-2]>data_inputs['ema100'].iloc[-2] and data_inputs['ema8'].iloc[-2]>data_inputs['ema100'].iloc[-2] and data_inputs['open_symbolused'].iloc[-2]<data_inputs['close_symbolused'].iloc[-2]:  # Buy action
                ...
                if actions[-2] == 1:
                    ...
                    sl_price = data_inputs['ema100'].iloc[-2]
            ...
            elif data_inputs['ema5'].iloc[-3]<data_inputs['ema100'].iloc[-3] and data_inputs['ema8'].iloc[-3]>data_inputs['ema100'].iloc[-3] and data_inputs['ema5'].iloc[-2]<data_inputs['ema100'].iloc[-2] and data_inputs['ema8'].iloc[-2]<data_inputs['ema100'].iloc[-2] and data_inputs['open_symbolused'].iloc[-2]>data_inputs['close_symbolused'].iloc[-2]:  # Sell action
